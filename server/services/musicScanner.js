...
export const MUSIC_FOLDERS = {
  fuckupp: process.env.MUSIC_DIR_FUCKUPP || "/home/omr/Music/Fuck upp/",
  nfak: process.env.MUSIC_DIR_NFAK || "/home/omr/Music/NFAK/",
};
...
function buildAudioUrl(folderKey, fileName) {
  return `/api/songs/stream/${folderKey}/${encodeURIComponent(fileName)}`;
}
